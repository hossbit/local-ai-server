...
|---|---|---|---|---|---|
| 2026-09-06 -> 2026-09-13 | llama.cpp: bleeding-edge (the project default channel) resolves to b10948 (5f436dd, 2026-09-13); stable channel unchanged at v0.4.0, whose binary pointer resolves to b10809. Last week's v0.4.0 row was the stable-family value recorded while the clone was missing; with the clone restored, tracking follows the default bleeding-edge channel again. llama-swap: unchanged at v255. No localai source changes required, no release. | b10948 (5f436dd) | v255 | cuda | 2026-09-13 |
